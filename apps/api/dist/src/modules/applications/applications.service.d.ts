...
export declare class ApplicationsService {
    ...
    constructor(prisma: PrismaService, workflowsService: WorkflowsService, slaService: SlaService, aiService: AiService);
    ...
    createPublic(dto: CreatePublicApplicationDto): Promise<{
        job: {
            id: string;
            updatedAt: Date;
            tenantId: string;
    ...
    findByJob(jobId: string, options?: {
        status?: string;
        stageId?: string;
    }): Promise<{
    ...
    moveToStage(id: string, stageId: string, userId?: string): Promise<{
        currentStage: {
            name: string;
            id: string;
            updatedAt: Date;
    ...
    calculateMatch(applicationId: string): Promise<void>;
    copyToJob(applicationIds: string[], targetJobId: string, userId: string): Promise<({
        id: string;
        status: string;
