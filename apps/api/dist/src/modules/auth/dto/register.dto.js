...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'RECRUITER', enum: ['ADMIN', 'RECRUITER', 'HIRING_MANAGER'] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(['ADMIN', 'RECRUITER', 'HIRING_MANAGER', 'INTERVIEWER']),
    __metadata("design:type", String)
