...
let PermissionsGuard = class PermissionsGuard {
    ...
    canActivate(context) {
        ...
        if (!user || (!user.role && !user.permissions)) {
            throw new common_1.ForbiddenException('User role or permissions not defined');
        }
        const userPermissions = user.permissions || permissions_1.ROLE_PERMISSIONS[user.role] || [];
