...
export declare class OnboardingService {
    ...
    create(createOnboardingDto: CreateOnboardingDto, tenantId: string): Promise<{
        tasks: {
            id: string;
            updatedAt: Date;
    ...
    uploadDocument(taskId: string, fileUrl: string): Promise<{
        id: string;
        updatedAt: Date;
        description: string | null;
        title: string;
    ...
    reviewDocument(taskId: string, status: 'APPROVED' | 'REJECTED'): Promise<{
        id: string;
        updatedAt: Date;
        description: string | null;
        title: string;
