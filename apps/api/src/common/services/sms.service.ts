...
export class SmsService {
     ...
     */
    async getSettings(tenantId: string): Promise<{ provider: string; fromNumber: string; isConfigured: boolean } | null> {
     ...
     * Send SMS via Twilio
     */
    private async sendViaTwilio(config: SmsConfig, options: SendSmsOptions): Promise<SendSmsResult> {
     ...
     */
    private async sendViaMsg91(config: SmsConfig, options: SendSmsOptions): Promise<SendSmsResult> {
     ...
     */
    private async logSmsAttempt(options: SendSmsOptions, result: SendSmsResult): Promise<void> {
        try {
