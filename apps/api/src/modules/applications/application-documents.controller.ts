...
export class ApplicationDocumentsController {
    ...
    async requestDocument(
        ...
        return this.documentsService.requestDocument(applicationId, dto, user.tenantId);
    }
    ...
    async reviewDocument(
        ...
        return this.documentsService.reviewDocument(documentId, dto, user.sub, user.tenantId);
    }
