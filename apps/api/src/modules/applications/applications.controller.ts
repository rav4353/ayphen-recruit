...
export class ApplicationsController {
  ...
  copyToJob(
    ...
    return this.applicationsService.copyToJob(
      applicationIds,
      targetJobId,
      user.sub,
    );
  ...
  bulkMoveStage(
    ...
    return this.applicationsService.bulkMoveStage(
      applicationIds,
      targetStageId,
      user.sub,
      user.tenantId,
  ...
  bulkReject(
    ...
    return this.applicationsService.bulkReject(
      applicationIds,
      reason,
      user.sub,
      user.tenantId,
  ...
  bulkAssign(
    ...
    return this.applicationsService.bulkAssign(
      applicationIds,
      assigneeId,
      user.sub,
      user.tenantId,
  ...
  bulkAddTags(
    ...
    return this.applicationsService.bulkAddTags(
      applicationIds,
      tags,
      user.sub,
      user.tenantId,
  ...
  pinNote(
    ...
    return this.applicationsService.pinNote(
      noteId,
      user.sub,
      user.tenantId,
      pinned,
  ...
  @ApiOperation({
    summary: "Get quick comparison stats for applications in a job",
  })
  getComparisonStats(
    @Param("jobId") jobId: string,
    @CurrentUser() user: JwtPayload,
  ...
  getCandidateLeaderboard(
    ...
    return this.applicationsService.getCandidateLeaderboard(
      jobId,
      user.tenantId,
      {
