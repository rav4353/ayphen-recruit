...
export class CalendarController {
    ...
    async saveGoogleConfig(@Body() dto: { clientId: string; clientSecret: string; redirectUri?: string }, @Req() req: any) {
        const tenantId = req.user.tenantId;
    ...
    async saveOutlookConfig(@Body() dto: { clientId: string; clientSecret: string; redirectUri?: string; tenantId?: string }, @Req() req: any) {
        const tenantId = req.user.tenantId;
    ...
    async getAuthUrl(@Query('provider') provider: 'GOOGLE' | 'OUTLOOK', @Req() req: any) {
    ...
    async updateEvent(@Param('id') eventId: string, @Body() dto: UpdateCalendarEventDto, @Req() req: any) {
        const userId = req.user.sub || req.user.id;
    ...
    @ApiOperation({ summary: 'Find common available slots across multiple users' })
