...
export class CandidateComparisonController {
  ...
  compareCandidates(
    ...
    return this.comparisonService.compareCandidates(body.candidateIds, user.tenantId);
  }
  ...
  compareJobCandidates(
    ...
    return this.comparisonService.compareJobCandidates(jobId, user.tenantId, limit ? parseInt(limit) : 5);
  }
  ...
  getComparisonSummary(
    ...
    return this.comparisonService.getComparisonSummary(body.candidateIds, user.tenantId);
  }
}
