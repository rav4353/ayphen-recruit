...
export class CandidateScoringController {
    ...
    getTopCandidates(
        ...
        return this.scoringService.getTopCandidates(user.tenantId, limit ? parseInt(limit, 10) : 10);
    }
    ...
    batchScore(
        ...
        return this.scoringService.batchScoreCandidates(body.candidateIds, body.jobId);
    }
}
