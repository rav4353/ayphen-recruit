...
} from "./candidate-notes.controller";
...
@Module({
  ...
  controllers: [
    ...
    ReferralsController,
    CandidateActivityController,
    CandidateNotesController,
    NotesSearchController,
    CandidateComparisonController,
    CandidateScoringController,
    CandidateTaggingController,
    CandidateDedupController,
