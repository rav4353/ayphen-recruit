...
export class SemanticSearchController {
    ...
    @ApiOperation({ 
        ...
        description: 'Search candidates using natural language queries like "React developers with 5+ years experience in fintech"'
    })
    @ApiResponse({ status: 200, description: 'List of matching candidates with scores' })
    ...
    @ApiResponse({ status: 200, description: 'List of candidates ranked by match score' })
    ...
    @ApiOperation({ 
        ...
        description: 'Get candidate recommendations based on role, skills, seniority, and industry'
    })
