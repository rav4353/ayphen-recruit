...
export class CareerSiteAdminController {
  ...
  updateBranding(@CurrentUser() user: JwtPayload, @Body() body: any) {
    return this.careerSiteService.updateConfig(user.tenantId, { branding: body });
  }
  ...
  updateCompanyInfo(@CurrentUser() user: JwtPayload, @Body() body: any) {
    return this.careerSiteService.updateConfig(user.tenantId, { companyInfo: body });
  }
  ...
  updateCustomCode(@CurrentUser() user: JwtPayload, @Body() body: any) {
    return this.careerSiteService.updateConfig(user.tenantId, { customCode: body });
  }
  ...
  @RequirePermissions(Permission.SETTINGS_EDIT)
  addPage(@CurrentUser() user: JwtPayload, @Body() body: { title: string; slug: string; content: string }) {
  ...
  @RequirePermissions(Permission.SETTINGS_EDIT)
  deleteTestimonial(@CurrentUser() user: JwtPayload, @Param('testimonialId') testimonialId: string) {
    return this.careerSiteService.deleteTestimonial(user.tenantId, testimonialId);
  }
...
export class CustomDomainController {
  ...
  @RequirePermissions(Permission.SETTINGS_EDIT)
  setSubdomain(@CurrentUser() user: JwtPayload, @Body() body: { subdomain: string }) {
  ...
  @RequirePermissions(Permission.SETTINGS_EDIT)
  addCustomDomain(@CurrentUser() user: JwtPayload, @Body() body: { domain: string }) {
  ...
  async getDnsInstructions(@CurrentUser() user: JwtPayload) {
    ...
    return this.domainService.getDnsInstructions(config.customDomain, config.verificationToken);
  }
}
...
export class ApplicationFormAdminController {
  ...
  @RequirePermissions(Permission.SETTINGS_EDIT)
  deleteField(@CurrentUser() user: JwtPayload, @Param('fieldId') fieldId: string) {
  ...
  @RequirePermissions(Permission.SETTINGS_EDIT)
  reorderFields(@CurrentUser() user: JwtPayload, @Body() body: { fieldIds: string[] }) {
...
export class PublicCareerSiteController {
  ...
  getApplicationForm(@Param('tenantId') tenantId: string, @Param('jobId') jobId: string) {
