...
export class CollaborationController {
  ...
  updateComment(
    ...
    return this.collaborationService.updateComment(
      user.tenantId,
      commentId,
      user.sub,
      body.content,
  ...
  updateNote(
    ...
    return this.collaborationService.updateNote(
      user.tenantId,
      noteId,
      user.sub,
      dto,
  ...
  deleteNote(@CurrentUser() user: JwtPayload, @Param("noteId") noteId: string) {
    return this.collaborationService.deleteNote(
      user.tenantId,
      noteId,
      user.sub,
    );
  ...
  getMentionSuggestions(
    ...
    return this.collaborationService.getMentionSuggestions(
      user.tenantId,
      query || "",
    );
  }
