...
export class EmailSequencesController {
  ...
  create(
    ...
    @Body() body: {
      ...
      steps: { subject: string; body: string; delayDays: number; delayHours: number; order: number }[];
    },
  ) {
  ...
  enrollCandidate(
    ...
    return this.sequencesService.enrollCandidate(id, candidateId, user.tenantId, user.sub);
  }
  ...
  unenrollCandidate(
    ...
    return this.sequencesService.unenrollCandidate(id, candidateId, user.tenantId, user.sub);
  }
  ...
  getCandidateEnrollments(
    ...
    return this.sequencesService.getCandidateEnrollments(candidateId, user.tenantId);
  }
}
