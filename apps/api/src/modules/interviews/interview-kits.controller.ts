...
export class InterviewKitsController {
  ...
  duplicate(
    ...
    return this.interviewKitsService.duplicate(id, body.name, user.tenantId, user.sub);
  }
  ...
  assignToInterview(
    ...
    return this.interviewKitsService.assignToInterview(id, interviewId, user.tenantId, user.sub);
  }
}
