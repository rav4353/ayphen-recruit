...
export class InterviewPanelsController {
    ...
    createPanel(
        ...
        return this.interviewsService.createInterviewPanel(jobId, user.tenantId, user.sub, body);
    }
    ...
    updatePanel(
        ...
        return this.interviewsService.updateInterviewPanel(panelId, user.tenantId, user.sub, body);
    }
    ...
    deletePanel(
        ...
        return this.interviewsService.deleteInterviewPanel(panelId, user.tenantId, user.sub);
    }
    ...
    getSuggestedInterviewers(
        ...
        return this.interviewsService.getSuggestedInterviewers(jobId, user.tenantId, date);
    }
}
...
export class InterviewFeedbackController {
    ...
    @ApiOperation({ summary: 'Get aggregated feedback summary for an application' })
    getFeedbackSummary(
        @Param('applicationId') applicationId: string,
        @CurrentUser() user: JwtPayload,
    ) {
        return this.interviewsService.getFeedbackSummary(applicationId, user.tenantId);
    }

    @Get('job/:jobId/comparison')
    @ApiOperation({ summary: 'Get feedback comparison across candidates for a job' })
    getFeedbackComparison(
        ...
        return this.interviewsService.getFeedbackComparison(jobId, user.tenantId, ids);
    }
    ...
    getPendingFeedbackRequests(@CurrentUser() user: JwtPayload) {
        return this.interviewsService.getPendingFeedbackRequests(user.sub, user.tenantId);
    }
}
