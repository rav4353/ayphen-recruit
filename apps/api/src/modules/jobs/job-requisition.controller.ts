...
export class JobRequisitionController {
  ...
  updateConfig(
    ...
    return this.requisitionService.updateApprovalWorkflowConfig(
      user.tenantId,
      config,
    );
  }
  ...
  approve(
    ...
    return this.requisitionService.approveStep(
      user.tenantId,
      id,
      user.sub,
      body.comment,
  ...
  reject(
    ...
    return this.requisitionService.rejectStep(
      user.tenantId,
      id,
      user.sub,
      body.reason,
  ...
  cancel(@CurrentUser() user: JwtPayload, @Param("id") id: string) {
    return this.requisitionService.cancelRequisition(
      user.tenantId,
      id,
      user.sub,
    );
  ...
  createJob(
    ...
    return this.requisitionService.createJobFromRequisition(
      user.tenantId,
      id,
      body,
    );
