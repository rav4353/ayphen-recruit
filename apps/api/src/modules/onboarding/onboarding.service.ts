...
export class OnboardingService {
  ...
  async create(createOnboardingDto: CreateOnboardingDto, tenantId: string) {
    ...
    if (existing) {
      throw new BadRequestException(
        "Onboarding workflow already exists for this application",
      );
    }
    ...
    const defaultTasks = [
      // Educational Documents
      {
        ...
        description:
          "Upload all educational marksheets (10th, 12th, Diploma, Degree, etc.). Please upload as a single PDF or multiple files.",
      ...
      },
      {
        ...
        description:
          "Upload your Transfer Certificate (TC) from your previous educational institution.",
        assigneeRole: OnboardingAssigneeRole.CANDIDATE,
        order: 2,
        isRequiredDoc: true,
      },
      ...
      // Identity Documents
      {
        ...
        description:
          "Upload a valid government-issued ID proof with address (Aadhaar Card, Driving License, Voter ID, or Passport). Ensure both sides are clearly visible.",
        assigneeRole: OnboardingAssigneeRole.CANDIDATE,
        order: 3,
        isRequiredDoc: true,
      },
      {
        ...
        description:
          "If you have a passport, please upload the first and last page. This is optional but recommended for future reference.",
        assigneeRole: OnboardingAssigneeRole.CANDIDATE,
        order: 4,
      ...
      // Experience Documents (for experienced candidates)
      {
        ...
        description:
          "Upload experience/relieving letters from all previous employers. If you are a fresher, you can skip this task.",
        assigneeRole: OnboardingAssigneeRole.CANDIDATE,
        order: 5,
      ...
      // Banking & Statutory Documents
      {
        ...
        description:
          "Upload a cancelled cheque or bank passbook first page showing your name, account number, and IFSC code.",
        assigneeRole: OnboardingAssigneeRole.CANDIDATE,
        order: 6,
        isRequiredDoc: true,
      },
      ...
      },
      {
        ...
        description:
          "If you have a previous PF (Provident Fund) account, upload your UAN card or PF passbook. If this is your first job, you can skip this.",
        assigneeRole: OnboardingAssigneeRole.CANDIDATE,
        order: 8,
      ...
      // Profile & Personal Information
      {
        ...
        description:
          "Upload a professional passport-size photograph for your employee ID card.",
        assigneeRole: OnboardingAssigneeRole.CANDIDATE,
        order: 9,
        isRequiredDoc: true,
      },
      {
        ...
        description:
          "Fill in your emergency contact details, permanent address, and other personal information.",
        assigneeRole: OnboardingAssigneeRole.CANDIDATE,
        order: 10,
        isRequiredDoc: false,
      },
      ...
      // HR Tasks
      {
        ...
        description:
          "Review and verify all uploaded documents for authenticity and completeness.",
      ...
      // IT Tasks
      {
        ...
        description:
          "Prepare and ship laptop, mouse, headset, and other required equipment to the new hire.",
      ...
      },
      {
        ...
        description:
          "Create email account and provide access to necessary systems and tools.",
        assigneeRole: OnboardingAssigneeRole.IT,
        order: 14,
        isRequiredDoc: false,
      },
      ...
      // Manager Tasks
      {
        ...
        description:
          "Organize a welcome meeting or team lunch for the new hire on their first day.",
      ...
      },
      {
        ...
        description:
          "Assign an onboarding buddy to help the new hire settle in.",
        assigneeRole: OnboardingAssigneeRole.MANAGER,
        order: 16,
        isRequiredDoc: false,
      },
    ...
    try {
      ...
      const candidateTasks = workflow.tasks.filter(
        (t) => t.assigneeRole === OnboardingAssigneeRole.CANDIDATE,
      );
  ...
  async findOne(id: string) {
    ...
    if (!workflow) {
      throw new NotFoundException(
        `Onboarding workflow with ID ${id} not found`,
      );
    }
    ...
    return [
      {
        title: "Upload Marksheets",
        description:
          "Upload all educational marksheets (10th, 12th, Diploma, Degree, etc.).",
        assigneeRole: OnboardingAssigneeRole.CANDIDATE,
        order: 1,
        isRequiredDoc: true,
      },
      ...
      },
      {
        title: "Upload ID Proof with Address",
        description:
          "Upload a valid government-issued ID proof with address (Aadhaar Card, Driving License, Voter ID, or Passport).",
        assigneeRole: OnboardingAssigneeRole.CANDIDATE,
        order: 3,
        isRequiredDoc: true,
      },
      {
        title: "Upload Passport (If Available)",
        description:
          "If you have a passport, please upload the first and last page. This is optional.",
        assigneeRole: OnboardingAssigneeRole.CANDIDATE,
        order: 4,
        isRequiredDoc: false,
      },
      {
        title: "Upload Experience Certificates",
        description:
          "Upload experience/relieving letters from all previous employers. Freshers can skip this.",
        assigneeRole: OnboardingAssigneeRole.CANDIDATE,
        order: 5,
        isRequiredDoc: false,
      },
      ...
      },
      {
        title: "Provide PF Details (If Applicable)",
        description:
          "If you have a previous PF account, upload your UAN card or PF passbook.",
        assigneeRole: OnboardingAssigneeRole.CANDIDATE,
        order: 8,
        isRequiredDoc: false,
      },
  ...
  private async sendOnboardingWelcomeEmail(workflow: any) {
    try {
      ...
      const job = workflow.application.job;
      const candidateTasks = workflow.tasks.filter(
        (t: any) => t.assigneeRole === OnboardingAssigneeRole.CANDIDATE,
      );
