import { Controller, Get, Put, Body, Param, UseGuards, Post, Patch, Delete } from '@nestjs/common';
...
export class SettingsController {
    ...
    @ApiResponse({ status: 200, description: 'Return status colors configuration.' })
    ...
    @ApiResponse({ status: 200, description: 'Status colors reset successfully.' })
