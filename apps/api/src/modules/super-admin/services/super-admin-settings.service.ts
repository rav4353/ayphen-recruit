...
export class SuperAdminSettingsService implements OnModuleInit {
  ...
  private async initializeDefaults() {
    const defaults = [
      ...
      // Feature flags
      {
        key: "feature_flag_ai_resume_parsing",
        value: true,
        category: "features",
      },
      {
        key: "feature_flag_ai_jd_generation",
        value: true,
        category: "features",
      },
      {
        key: "feature_flag_video_interviews",
        value: false,
        category: "features",
      },
      {
        key: "feature_flag_advanced_analytics",
        value: true,
        category: "features",
      },
      ...
      {
        key: "feature_flag_ai_candidate_matching",
        value: true,
        category: "features",
      },
      { key: "feature_flag_esignature", value: true, category: "features" },
      {
        key: "feature_flag_background_checks",
        value: true,
        category: "features",
      },
  ...
  async getFeatureFlagsWithMetadata() {
    const featureFlagMetadata: Record<
      string,
      { name: string; description: string }
    > = {
      ai_resume_parsing: {
        name: "AI Resume Parsing",
        description: "Enable AI-powered resume parsing for candidates",
      },
      ai_jd_generation: {
        name: "AI Job Description",
        description: "Enable AI-assisted job description generation",
      },
      video_interviews: {
        name: "Video Interviews",
        description: "Enable integrated video interview functionality",
      },
      advanced_analytics: {
      ...
      calendar_sync: {
        name: "Calendar Sync",
        description: "Enable calendar integration for interview scheduling",
      },
      bulk_actions: {
        name: "Bulk Actions",
        description: "Enable bulk operations on candidates and applications",
      },
      ...
      esignature: {
        name: "E-Signature",
        description: "Enable electronic signature for offer letters",
      },
      background_checks: {
        name: "Background Checks",
        description: "Enable background verification integration",
      },
      onboarding: {
        name: "Onboarding",
        description: "Enable employee onboarding workflows",
      },
    };
    ...
    return flags.map((f) => {
      ...
      const metadata = featureFlagMetadata[key] || {
        name: key,
        description: "",
      };
      return {
