    ...
    return (
        <div className="h-full min-h-0 flex flex-col gap-6">
            ...
            {activeTab === 'auth' && (
                <div className="space-y-6">
                    <Card>
                        <CardHeader title="Single Sign-On (SSO)" description="Configure enterprise authentication providers." />
                        <div className="p-6 space-y-4">
                            <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mb-4">
                                <div className="flex items-start gap-3">
                                    <Shield className="text-amber-600 dark:text-amber-400 mt-0.5" size={20} />
                                    <div>
                                        <h4 className="font-medium text-amber-900 dark:text-amber-100 mb-1">Enterprise Feature</h4>
                                        <p className="text-sm text-amber-700 dark:text-amber-300">
                                            SSO authentication is available on Enterprise plans. Contact your account manager or upgrade your plan to enable these features.
                                        </p>
                                    </div>
                                </div>
                            </div>

                            <div className="flex items-center justify-between p-4 border border-neutral-200 dark:border-neutral-700 rounded-lg opacity-60">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-neutral-500">Sign in with Google accounts</p>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-center justify-between p-4 border border-neutral-200 dark:border-neutral-700 rounded-lg opacity-60">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-neutral-500">Sign in with Microsoft accounts</p>
                                    </div>
                                </div>
                                <Button variant="secondary" disabled>Configure</Button>
                            </div>
                    ...
                    <Card>
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <select className="w-full px-3 py-2 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" disabled>
                                ...
                                <p className="text-xs text-neutral-500 mt-1">Users will be logged out after inactivity. (Enterprise feature)</p>
                            </div>
                        </div>
                    </Card>
                </div>
