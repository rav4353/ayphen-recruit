...
export const ROLE_PERMISSIONS: Record<string, Permission[]> = {
    ...
    RECRUITER: [
        ...
        Permission.INTERVIEW_VIEW, Permission.INTERVIEW_SCHEDULE, Permission.INTERVIEW_CANCEL, Permission.INTERVIEW_FEEDBACK_VIEW, Permission.INTERVIEW_FEEDBACK_CREATE,
        Permission.OFFER_VIEW, Permission.OFFER_CREATE, Permission.OFFER_EDIT,
        Permission.PIPELINE_VIEW,
        Permission.EMAIL_SEND, Permission.EMAIL_TEMPLATE_MANAGE,
        Permission.REPORT_VIEW, Permission.ANALYTICS_EXPORT
    ],
    HIRING_MANAGER: [
        Permission.CANDIDATE_VIEW,
        Permission.JOB_VIEW, Permission.JOB_APPROVE,
        Permission.INTERVIEW_VIEW, Permission.INTERVIEW_FEEDBACK_VIEW, Permission.INTERVIEW_FEEDBACK_CREATE,
